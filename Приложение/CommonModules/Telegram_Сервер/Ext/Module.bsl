...
КонецПроцедуры
  ...
  Процедура ОбработатьОтветПользователя(Команда, СтруктураНастроек, СтруктураСообщения, СообщениеID)
	...
	ИначеЕсли СтрНайти(Команда, "+7") Тогда
		...
		ОтветСистемы = "Спасибо, мы сохранили ваш контакт в системе";
		Телефон =Команда;
	...
	ИначеЕсли Отзыв.ЭтоОтзыв Тогда
		...
		ОтветСистемы = "Привет, я Плюсик✌"+Символы.ПС+"Я помогу тебе отслеживать свой рейтинг и баланс бонусов"+Символы.ПС+"Скорее регистрируйся!";
...
Процедура ЗаписатьИсториюОтветов(ОтветСистемы, Команда, IDСообщения, IDПользователя)
